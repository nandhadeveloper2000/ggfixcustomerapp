...
import {
  TrendingUp, ShieldCheck, Sparkles, Bell, Search,
  MapPin, ChevronDown, Tag,
        ...
        >
          <View style={{ paddingHorizontal: padH }}>
            ...
            <Text style={{ color: 'rgba(255,255,255,0.85)', fontSize: 12.5, marginTop: 3 }}>
              Best price from verified shops nearby.
            </Text>
            ...
            >
              ...
              <View style={{ backgroundColor: '#DCFCE7', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 }}>
                <Text style={{ color: GREEN_DARK, fontSize: 11, fontWeight: '800' }}>QUOTE</Text>
              </View>
            </Pressable>
          </View>
        </LinearGradient>
        ...
        <View style={{ paddingHorizontal: padH }}>
          {STEPS.map((s) => (
            <View key={s.n} style={{ flexDirection: 'row', alignItems: 'flex-start', marginBottom: 8 }}>
              ...
              >
                <Text style={{ fontSize: 13, fontWeight: '800', color: '#0F172A' }}>{s.title}</Text>
