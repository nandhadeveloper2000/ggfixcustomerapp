...
import {
  ...
  ChevronDown, ShieldCheck, Wrench, Clock,
  Search, MapPin, Bell,
...
const CODE_META = {
  MOBILE:        { icon: Smartphone, color: '#16A34A', bg: '#DCFCE7', emoji: '📱', sub: 'iPhone, Android · all brands' },
  SMARTPHONE:    { icon: Smartphone, color: '#16A34A', bg: '#DCFCE7', emoji: '📱', sub: 'iPhone, Android · all brands' },
...
const DEFAULT_META = { icon: Smartphone, color: '#16A34A', bg: '#DCFCE7', emoji: '📱', sub: 'Tap to see all brands' };
...
const PROMISES = [
  { icon: ShieldCheck, label: '30-day Warranty', tint: '#DCFCE7', color: GREEN_DARK },
  { icon: Wrench,      label: 'Certified Techs', tint: '#FFEDD5', color: '#C2410C' },
  { icon: Clock,       label: 'Same-day Fix',    tint: '#FEF3C7', color: '#B45309' },
];
        ...
        >
          <View style={{ paddingHorizontal: padH }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 2 }}>
                  <Text
                    numberOfLines={1}
                    style={{ color: '#fff', fontWeight: '700', fontSize: 15, maxWidth: width - 120 }}
                  >
            ...
            <Text style={{ color: 'rgba(255,255,255,0.85)', fontSize: 12.5, marginTop: 3 }}>
              Trusted shops · Doorstep pickup · Genuine parts
            </Text>
            ...
            >
              ...
              <View style={{ backgroundColor: '#DCFCE7', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 }}>
                <Text style={{ color: GREEN_DARK, fontSize: 11, fontWeight: '800' }}>FAST</Text>
              </View>
            </Pressable>
          </View>
        </LinearGradient>
